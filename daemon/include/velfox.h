...
#define NOTIFY_TITLE "Velfox Tweaks"
#define LOG_TAG "VelfoxTweaks"

#define LOCK_FILE "/data/adb/.config/Velfox/.lock"
#define LOG_FILE "/data/adb/.config/Velfox/velfox.log"
#define PROFILE_MODE "/data/adb/.config/Velfox/current_profile"
#define GAME_INFO "/data/adb/.config/Velfox/gameinfo"
#define GAMELIST "/data/adb/.config/Velfox/gamelist.txt"
#define MODULE_PROP "/data/adb/modules/velfox/module.prop"
#define MODULE_UPDATE "/data/adb/modules/velfox/update"
...
// Logging system
void log_velfox(LogLevel level, const char* message, ...);
